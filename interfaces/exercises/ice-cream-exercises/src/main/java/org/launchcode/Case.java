...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Hot Fudge", .50, new ArrayList<>( Arrays.asList( "dairy" )));
        Topping topping2 = new Topping("Reese's Pieces", .50, new ArrayList<>( Arrays.asList( "dairy", "red #5", "nuts")));
        Topping topping3 = new Topping("Caramel Drizzle", .50, new ArrayList<>( Arrays.asList( "dairy" )));
        Topping topping4 = new Topping("Cherries", .50, new ArrayList<>( Arrays.asList( "cherry" )));
        Topping topping5 = new Topping("Ande's Mints", .50, new ArrayList<>( Arrays.asList( "dairy", "mint" )));
